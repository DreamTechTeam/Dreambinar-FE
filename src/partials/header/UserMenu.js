      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
            ...
            <div className="text-xs text-slate-500 italic">Ormawa</div>
          </div>
          <ul>
            <li>
              <Link
            ...
            <li>
              <div
                className="font-medium text-sm text-red-500 hover:text-red-600 hover:cursor-pointer flex items-center py-1 px-3"
                onClick={onLogout}
              >
                Logout
              </div>
