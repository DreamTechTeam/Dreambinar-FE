        ...
        <FormProvider {...methods}>
          <form onSubmit={methods.handleSubmit(onSubmit)}>
            <div className="p-6 md:p-8 xl:p-10 bg-white rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-1 mt-6">
                <div className="row-end-2 md:row-end-auto md:col-span-2 pb-0 md:pr-8 xl:pr-10 border-r-0 md:border-r">
                  <div className="mb-6">
                ...
                <div className="h-fit md:sticky md:top-20 xl:top-24">
                  <div className="pt-0 md:pl-8 xl:pl-10">
                    <div className="mb-6">
                      <div className="mb-2 block">
